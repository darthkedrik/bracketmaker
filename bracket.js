...
// The base of this program is taken from the google sheets tutorial for
// building a sports bracket. Randomization has been added, and some stuff
// adjusted to make it fit our needs better.
...
// This method randomizes the participants.
function shuffleBracket(arr) {
  var curIndex = arr.length, tempValue, randomIndex;
...
function createBracket() {
  ...
  players = shuffleBracket(players);
